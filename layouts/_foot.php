            ...
            <div class="row">
                ...
                <div class="col-md-4 text-md-right">
                    <p class="mb-8pt d-flex align-items-md-center justify-content-md-end">
                        <a href="<?= WEBSITE_URL . DIRECTORY_SEPARATOR . 'policy/terms-conditions' ?>" title="terms and condition" class="text-white-70 text-underline mr-16pt">Terms</a>
                        <a href="<?= WEBSITE_URL . DIRECTORY_SEPARATOR . 'policy/privacy-policy' ?>" title="privacy policy" class="text-white-70 text-underline">Privacy policy</a>
                    </p>
