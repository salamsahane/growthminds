        ...
        <div class="sidebar sidebar-dark sidebar-left" data-perfect-scrollbar>
            <div class="sidebar-p-a sidebar-b-b sidebar-m-b pt-0">
                ...
                <a href="/" class="sidebar-brand">
                    <img class="sidebar-brand-icon" src="/assets/images/logo/white-100.svg" width="30" alt="Growth Minds">
                    <span>Growth Minds</span>
                </a>
                <!-- // END Brand -->

                <!-- Search -->
                <form action="http://tutorio-bootstrap.frontendmatter.com/library-filters.html"
