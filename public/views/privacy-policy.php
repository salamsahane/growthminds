...
<div class="mdk-header-layout__content page-content pb-0">
    <div class="container page__container" style="text-align: justify">
        <h1>Privacy Policy of Growthminds</h1>

        <p>Growthminds operates the <a href="https://growthminds.online">https://growthminds.online</a> website, which provides the SERVICE.</p>

        <p>This page is used to inform website visitors regarding our policies with the collection, use, and disclosure
            of Personal Information if anyone decided to use our Service, the Growthminds website.</p>
        ...
        <p>The terms used in this Privacy Policy have the same meanings as in our <a href="/policy/terms-conditions">Terms and Conditions</a>, unless otherwise defined in this Privacy Policy. Our Privacy
            Policy was created with the help of the <a href="https://www.privacypolicytemplate.net">Privacy Policy
                Template</a> and the <a href="https://www.privacy-policy-template.com/">Online Privacy Policy
                Template</a>.</p>
        ...
        <h2>Contact Us</h2>
        <p>If you have any questions or suggestions about our Privacy Policy, do not hesitate to <a href="https://growthminds.online/home/contact-us">Contact US</a>.</p>
    </div>
</div>
