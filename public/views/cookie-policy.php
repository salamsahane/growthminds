...
<div class="mdk-header-layout__content page-content pb-0">
    ...
    <h1>Cookie Policy for Growthminds</h1>

    <p>This is the Cookie Policy for Growthminds, accessible from <a href="https://growthminds.online">https://growthminds.online</a></p>
    ...
    <ul>
        ...
        <li>
            ...
            <p>We use cookies when you are logged in so that we can remember this fact. This prevents you from having to
                log
                in every single time you visit a new page. These cookies are typically removed or cleared when you log
                out
                to ensure that you can only access restricted features and areas when logged in.</p>
        </li>
    ...
    <ul>
        ...
        <li>
            <p>From time to time we test new features and make subtle changes to the way that the site is delivered.
                When we
                are still testing new features these cookies may be used to ensure that you receive a consistent
                experience
        ...
        <li>
            <p>As we sell products it's important for us to understand statistics about how many of the visitors to our
                site
                actually make a purchase and as such this is the kind of data that these cookies will track. This is
        ...
        <li>
            <p>We use adverts to offset the costs of running this site and provide funding for further development. The
                ...
                most
                relevant adverts where possible by anonymously tracking your interests and presenting similar things
                that
    ...
    <p>Hopefully that has clarified things for you and as was previously mentioned if there is something that you aren't
        ...
        the features you use on our site. This Cookies Policy was created with the help of the <a
    ...
    <ul>
        <li>Email: info@growthminds.online</li>
        <li>By visiting this link: <a href="https://growthminds.online/home/contact-us">Contact US</a></li>
    </ul>
    </div>
</div>
